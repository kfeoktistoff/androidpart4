...
public abstract class ImageOpsImpl {
    ...
    private void resetNonViewFields() {
        ...
        // Clear the URL list.
        mUrlList.clear();
        mUrlList.add("https://www.kernel.org/theme/images/logos/tux.png");
        mUrlList.add("https://www.google.ru/images/srpr/logo11w.png");
        mUrlList.add("https://www.debian.org/logos/openlogo-100.png");
        mUrlList.add("https://www.fake.image.png");
